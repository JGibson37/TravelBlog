...
public class CityController {
    ...
    public CityController() {
        cities.put("Bruce Peninsula", new City("Bruce Peninsula", "Star Rating: 5 / 5", "Bruce Peninsula National Park", "Fish & Chip Place", "The Bruce Peninsula is an astounding area to visit if you enjoy hiking and\n" +
        ...
        cities.put("Cinque-Terre", new City("Cinque-Terre", "Star Rating: 5 / 5", "Boat Taxi", "Terre Trail", "We got to Cinque Terre and our mouths dropped. It had breath taking views. \n" +
        ...
        cities.put("Florence", new City("Florence", "Star Rating 3 / 5", "Galleria dell'Accademia", "Cathedral of Santa Maria del Fiore", "The city was full of tourist and students. The Galleria dell'Accademia housed \n" +
        ...
        cities.put("Gettysburg", new City("Gettysburg", "Star Rating 4 / 5", "Gettysburg National Military Park", "The Links At Gettysburg", "Gettysburg National Military Park is rated number one on things to do in Gettysburg, Pennsylvania, this\n" +
        ...
        cities.put("Jeju Island", new City("Jeju Island", "Star Rating 5 / 5", "Jungmun Lava Columns", "Museum of Glass", "These columns are located near the Mangnan Lava Tubes. They are formed by\n" +
        ...
        cities.put("Nassau", new City ("Nassau", "Star Rating 4 / 5 ", "Cable Beach", "Blue Lagoon Island", "Nassau is known for quite a few attractions, including Cable Beach, Blue \n" +
