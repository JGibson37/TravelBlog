...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        City brucePeninsula = new City("Bruce Peninsula", "Star Rating: 5 / 5", "Bruce Peninsula National Park", "Fish & Chip Place", "The Bruce Peninsula is an astounding area to visit if you enjoy hiking and\n" +
                ...
                "      don't even like fish!", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/brucepeninsulacliffs.jpg",canada);
        City stratford = new City("Stratford", "Star Rating 3 / 5", "Strafords Shakespeare Festival",
                "Rocky mountain Hershey Chocolate Factory",
                "Stratford is a gorgeous little town just north of the border. If you are able to visit during the annual Shakespeare festival you'll be treated to a plethora of wonderful stage performances, and if that is not quite your style I must recommend the quiet joy of a candied apple while strolling the river Avon.", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/stratfordavonriver.jpg", canada);
        City cinqueTerre = new City("Cinque-Terre", "Star Rating: 5 / 5", "Boat Taxi", "Terre Trail", "We got to Cinque Terre and our mouths dropped. It had breath taking views. \n" +
                ...
                "        for dinner.", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/cinque-terre1.jpg", italy);
        City florence = new City("Florence", "Star Rating 3 / 5", "Galleria dell'Accademia", "Cathedral of Santa Maria del Fiore", "The city was full of tourist and students. The Galleria dell'Accademia housed \n" +
                ...
                "        are a few safety concerns with pick pickpockets. Be sure to keep your belongings safe.", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/florence1.jpg", italy);
        City gettysburg = new City("Gettysburg", "Star Rating 4 / 5", "Gettysburg National Military Park", "The Links At Gettysburg", "Gettysburg National Military Park is rated number one on things to do in Gettysburg, Pennsylvania, this\n" +
                ...
                "      has a spacious indoor/outdoor bar with great food", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/gettysburg-links.jpg", unitedStates);
        City jejuIsland = new City("Jeju Island", "Star Rating 5 / 5", "Jungmun Lava Columns", "Museum of Glass", "These columns are located near the Mangnan Lava Tubes. They are formed by\n" +
                ...
                "      of them are scenic views, like trees and flowers. ", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/JejuColumns.jpg", southKorea);
        City lucaya = new City("Lucaya", "Start Rating 4 / 5", "Count Basie Square", "Leo's Art Gallery", " Here is what to do in Lucaya. Count Basie Square, Leo's Art Gallery, and Neptune's Cocktail Lounge are just to name a few. O, you can't forget Pelican Bay. I still haven't figured out how you can be on what seems like the top of a mountain and on the beach at the same time. Everything here seems perfect. You can't go wrong and the Marina is just at the bottom of the drive.", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/lbahama2.jpg", bahamas);
        City miami = new City("Miami", "Star Rating 4 / 5", "Vizcaya Museum and Gardens ", "Wynwood Walls", "A historical Italian estate first built in 1916 as a private winter\n" +
                ...
                "      must see! ", "https://raw.githubusercontent.com/2020-Summer-Cohort/reviews-site-codingonthefly/dev/src/main/resources/static/images/wynwood-walls.jpg", unitedStates);
        City nassau = new City("Nassau", "Star Rating 4 / 5 ", "Cable Beach", "Blue Lagoon Island", "Nassau is known for quite a few attractions, including Cable Beach, Blue \n" +
