...
public class Country {
    ...
    public void populateCities() {
        ...
        CountryStorage country = new CountryStorage();
        country.country1.addCity(nassau);
        country.country1.addCity(lucaya);
        country.country2.addCity(brucePeninsula);
        country.country2.addCity(stratford);
        country.country3.addCity(cinqueTerre);
        country.country3.addCity(florence);
        country.country4.addCity(jejuIsland);
        country.country4.addCity(seoul);
        country.country5.addCity(gettysburg);
        country.country5.addCity(miami);
    }
